...
namespace BismNormalizer.TabularCompare
{
    ...
    public static class ComparisonFactory
    {
        ...
        private static List<int> _supportedCompatibilityLevels = new List<int>() { 1100, 1103, 1200 }; //todo 1400
